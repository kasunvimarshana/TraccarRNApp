...
export const fetchStart = () => {
    return {
        type: REPORT_REPORT_TRIP_FETCH_START,
        payload: null
    }
};
...
export const fetchEnd = () => {
    return {
        type: REPORT_REPORT_TRIP_FETCH_END,
        payload: null
    }
};
...
export const fetchTrips = (fetchType, from = null, to = null, isCheckAuth = false) => {
    return (dispatch, getState) => {
        const promise = new Promise((resolve, reject) => { 
            ...
            .then((user) => {
                ...
                const api_url = buildURLWithQueryString(remote_location_api_uri + "/reports/trips", queryParameters);
            ...
            .then(async (json) => {
                console.log(json);
                await dispatch( setReportTripList( json ) );
                dispatch( fetchEnd() );
                return resolve( json );
            })
            .catch((error) => {
...
export const setReportTripList = ( reportTripList ) => {
    return {
        type: SET_REPORT_REPORT_TRIP_LIST,
        reportTripList: reportTripList
    }
};