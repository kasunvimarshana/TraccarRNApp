...
export const fetchStart = () => {
    return {
        type: REPORT_POSITION_FETCH_START,
        payload: null
    }
};
...
export const fetchEnd = () => {
    return {
        type: REPORT_POSITION_FETCH_END,
        payload: null
    }
};
...
export const fetchPositions = (fetchType, from = null, to = null, type = null, isCheckAuth = false) => {
    return (dispatch, getState) => {
        const promise = new Promise((resolve, reject) => { 
            ...
            .then(async (json) => {
                console.log(json);
                await dispatch( setPositionList( json ) );
                dispatch( fetchEnd() );
                return resolve( json );
            })
            .catch((error) => {
...
export const setPositionList = ( positionList ) => {
    return {
        type: SET_REPORT_POSITION_LIST,
